...
const getUserSubscriptionRoute = require('./subscriptions/getUserSubscription');
// Add album routes
...
module.exports = function(fastify, opts, done) {
    ...
    // Register user related routes with /api prefix
    fastify.register(userQuotaRoute, { prefix: '/api' });
    fastify.register(getUserSubscriptionRoute, { prefix: '/api' });
